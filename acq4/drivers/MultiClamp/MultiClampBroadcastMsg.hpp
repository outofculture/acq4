...
//          Guy Burkitt, Apr 2005
//             Removed constructor and Initialize method from MC_TELEGRAPH_DATA

#ifndef INC_MCBROADCASTMSG_HPP
#define INC_MCBROADCASTMSG_HPP

#include "\Axondev\Comp\CommonLib\MDCDebug.h"

////////////////////////////////////////////////
/// MultiClamp Telegraph API Version
////////////////////////////////////////////////
const UINT MCTG_API_VERSION      = 14;
...
//       Set struct member alignment to 8 bytes ( i.e. /Zp8 ) in your project.
//       It you extend/change this structure be sure to bump the API version
//
#pragma pack (push,4)
...
STATIC_ASSERT(sizeof(MC_TELEGRAPH_DATA) == 256);
#pragma pack (pop)
